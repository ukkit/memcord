<div align="center">
  ...
  <h3>MEMCORD v3.0.0 (mcp server)</h3>
...
> **[What's new in v3.0.0](docs/versions.md#v300---pluggable-summarizer-backends--per-slot-config)** — Pluggable summarizer backends (sumy, semantic, transformers) with per-slot config and the new `memcord_configure` tool.
