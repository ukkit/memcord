...
class TemporalParser:
    ...
    @classmethod
    def parse_timestamp(cls, timestamp_str: str) -> Optional[datetime]:
    ...
    @classmethod
    def parse_relative_time(cls, relative_str: str) -> Optional[Tuple[str, Optional[int], Optional[datetime]]]:
        """
    ...
    @classmethod
    def find_closest_entry_by_time(cls, entries: List, target_time: datetime, 
                                 tolerance_minutes: int = 30) -> Optional[Tuple[int, object]]:
        """
    ...
    @classmethod
    def get_entry_by_ordinal(cls, entries: List, mode: str, ordinal: int) -> Optional[Tuple[int, object]]:
        """
    ...
    @classmethod
    def validate_selection_input(cls, timestamp: Optional[str] = None, 
                                relative_time: Optional[str] = None,
                                entry_index: Optional[int] = None) -> Tuple[bool, str]:
        """
        ...
        if provided_methods == 0:
            ...
            return (False, "Cannot specify multiple selection methods. Choose only one of: timestamp, relative_time, or entry_index")
