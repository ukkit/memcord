...
class MemorySlotMerger:
    ...
    def create_merge_preview(
        ...
        duplicate_groups = self.similarity_analyzer.find_duplicate_paragraphs(
            content_blocks, similarity_threshold
        )
    ...
    def _merge_content(
        ...
        deduplicated_sections = self._remove_duplicate_sections(
            content_sections, similarity_threshold
        )
