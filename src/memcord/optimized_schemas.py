        ...
        return [
            ...
            Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "check_type": {"type": "string", "enum": ["health", "performance", "full_report"], "default": "health"}
                    }
                }
            )
        ]
        ...
        return [
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "source": {"type": "string"},
                        "slot_name": {"type": "string"},
                        "source_type": {"type": "string", "enum": ["auto", "text", "pdf", "url", "csv", "json"], "default": "auto"},
                        "tags": {"type": "array", "items": {"type": "string"}, "default": []},
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "slot_name": {"type": "string"},
                        "action": {"type": "string", "enum": ["analyze", "compress", "decompress", "stats"], "default": "analyze"},
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "slot_name": {"type": "string"},
                        "formats": {"type": "array", "items": {"type": "string", "enum": ["md", "txt", "json"]}, "default": ["md", "txt"]},
                        "include_metadata": {"type": "boolean", "default": True}
                    },
                    "required": ["slot_name"]
                }
