...
class RateLimiter:
    ...
    def is_allowed(self, client_id: str, operation: str) -> tuple[bool, str | None]:
...
class PathValidator:
    ...
    @staticmethod
    def is_safe_path(path: str, allowed_dirs: list[str] | None = None) -> tuple[bool, str | None]:
        ...
        try:
            ...
            if os.path.isabs(normalized) and allowed_dirs:
                allowed = any(normalized.startswith(os.path.abspath(allowed_dir)) for allowed_dir in allowed_dirs)
                if not allowed:
...
class InputValidator:
    ...
    @staticmethod
    def validate_compression_ratio(ratio: float) -> tuple[bool, str | None]:
    ...
    @staticmethod
    def validate_content_type(content_type: str, allowed_types: list[str] | None = None) -> tuple[bool, str | None]:
...
class SecurityMiddleware:
    ...
    def validate_request(self, client_id: str, operation: str, arguments: dict) -> tuple[bool, str | None]:
    ...
    def _validate_import_request(self, arguments: dict) -> tuple[bool, str | None]:
    ...
    def _validate_save_request(self, arguments: dict) -> tuple[bool, str | None]:
    ...
    def _validate_compress_request(self, arguments: dict) -> tuple[bool, str | None]:
